    ...
    public function addNewUserDetailsAPI($params)
    {
        ...
        if($result > 0){
            if($params->LoginType != 'facebook' && $result['Status'] == 'success'){
                ...
                $link = "<a href='$domainUrl'activate/$uniqueId'>".$domainUrl.'activate/'.$uniqueId."</a>";
                $subject = 'Wheelspa Service User Activation';
                $msg = "HI <b>$name</b>,<br><br>Thank you for registering for the Wheelsa Tyre Service Center. You are just a click away from activating your account. To activate your account please click here $link or copy and paste the URL in the browser.<br><br>Regards <br>Wheelspa Tyre Service Center";
